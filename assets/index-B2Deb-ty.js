...
void main() {
	...
	gl_FragColor = pack2HalfToRGBA( vec2( mean, std_dev ) );
      ...
      `,transparent:!0,depthWrite:!1,blending:ro}),Ge=new Vu(ge,Ze);Ae.add(Ge);const Le=new jn,Te=500,he=new Float32Array(Te*3),ze=new Float32Array(Te);for(let Se=0;Se<Te;Se++)he[Se*3]=(Math.random()-.5)*300,he[Se*3+1]=(Math.random()-.5)*400,he[Se*3+2]=(Math.random()-.5)*300,ze[Se]=2+Math.random()*3;Le.setAttribute("position",new Dt(he,3)),Le.setAttribute("size",new Dt(ze,1));const Ke=new ei({uniforms:{uTime:{value:0}},vertexShader:`
        attribute float size;
        uniform float uTime;
