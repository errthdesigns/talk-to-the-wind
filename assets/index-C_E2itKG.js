...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Yi,depthTest:!1,depthWrite:!1})}function dp(){return new ni({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Jf(),fragmentShader:`
		...
		`,blending:Yi,depthTest:!1,depthWrite:!1})}function hp(){return new ni({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Jf(),fragmentShader:`
		...
		`,blending:Yi,depthTest:!1,depthWrite:!1})}function Jf(){return`
...
void main() {
	...
	gl_FragColor = pack2HalfToRGBA( vec2( mean, std_dev ) );
      ...
      `,transparent:!0,depthWrite:!1,blending:lo}),He=new Wu(w,Ae);ee.add(He);const J=new Yn,Qe=2e3,Be=new Float32Array(Qe*3),Ne=new Float32Array(Qe);for(let Me=0;Me<Qe;Me++)Be[Me*3]=(Math.random()-.5)*900,Be[Me*3+1]=(Math.random()-.5)*600,Be[Me*3+2]=(Math.random()-.5)*600,Ne[Me]=.5+Math.random()*1.5;J.setAttribute("position",new Ut(Be,3)),J.setAttribute("size",new Ut(Ne,1));const Ce=new ni({uniforms:{uTime:{value:0}},vertexShader:`
        attribute float size;
        uniform float uTime;
      ...
      `,transparent:!0,depthWrite:!1,blending:lo}),xe=new Wu(J,Ce);ee.add(xe);const Fe=new Yn,$e=500,lt=new Float32Array($e*3),Ge=new Float32Array($e);for(let Me=0;Me<$e;Me++)lt[Me*3]=(Math.random()-.5)*300,lt[Me*3+1]=(Math.random()-.5)*400,lt[Me*3+2]=(Math.random()-.5)*300,Ge[Me]=2+Math.random()*3;Fe.setAttribute("position",new Ut(lt,3)),Fe.setAttribute("size",new Ut(Ge,1));const oe=new ni({uniforms:{uTime:{value:0}},vertexShader:`
        attribute float size;
        uniform float uTime;
