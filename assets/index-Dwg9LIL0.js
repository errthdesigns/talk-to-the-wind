 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(t){function e(L,O){var G=L.length;L.push(O);e:for(;0<G;){var j=G-1>>>1,K=L[j];if(0<r(K,O))L[j]=O,L[G]=K,G=j;else break e}}function n(L){return L.length===0?null:L[0]}function i(L){if(L.length===0)return null;var O=L[0],G=L.pop();if(G!==O){L[0]=G;e:for(var j=0,K=L.length,z=K>>>1;j<z;){var $=2*(j+1)-1,fe=L[$],ve=$+1,Ee=L[ve];if(0>r(fe,G))ve<K&&0>r(Ee,fe)?(L[j]=Ee,L[ve]=G,j=ve):(L[j]=fe,L[$]=G,j=$);else if(ve<K&&0>r(Ee,G))L[j]=Ee,L[ve]=G,j=ve;else break e}}return O}function r(L,O){var G=L.sortIndex-O.sortIndex;return G!==0?G:L.id-O.id}if(typeof performance=="object"&&typeof performance.now=="function"){var s=performance;t.unstable_now=function(){return s.now()}}else{var o=Date,a=o.now();t.unstable_now=function(){return o.now()-a}}var l=[],u=[],d=1,h=null,f=3,m=!1,x=!1,_=!1,p=typeof setTimeout=="function"?setTimeout:null,c=typeof clearTimeout=="function"?clearTimeout:null,g=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function v(L){for(var O=n(u);O!==null;){if(O.callback===null)i(u);else if(O.startTime<=L)i(u),O.sortIndex=O.expirationTime,e(l,O);else break;O=n(u)}}function M(L){if(_=!1,v(L),!x)if(n(l)!==null)x=!0,X(C);else{var O=n(u);O!==null&&q(M,O.startTime-L)}}function C(L,O){x=!1,_&&(_=!1,c(N),N=-1),m=!0;var G=f;try{for(v(O),h=n(l);h!==null&&(!(h.expirationTime>O)||L&&!W());){var j=h.callback;if(typeof j=="function"){h.callback=null,f=h.priorityLevel;var K=j(h.expirationTime<=O);O=t.unstable_now(),typeof K=="function"?h.callback=K:h===n(l)&&i(l),v(O)}else i(l);h=n(l)}if(h!==null)var z=!0;else{var $=n(u);$!==null&&q(M,$.startTime-O),z=!1}return z}finally{h=null,f=G,m=!1}}var R=!1,A=null,N=-1,E=5,T=-1;function W(){return!(t.unstable_now()-T<E)}function Y(){if(A!==null){var L=t.unstable_now();T=L;var O=!0;try{O=A(!0,L)}finally{O?ie():(R=!1,A=null)}}else R=!1}var ie;if(typeof g=="function")ie=function(){g(Y)};else if(typeof MessageChannel<"u"){var P=new MessageChannel,V=P.port2;P.port1.onmessage=Y,ie=function(){V.postMessage(null)}}else ie=function(){p(Y,0)};function X(L){A=L,R||(R=!0,ie())}function q(L,O){N=p(function(){L(t.unstable_now())},O)}t.unstable_IdlePriority=5,t.unstable_ImmediatePriority=1,t.unstable_LowPriority=4,t.unstable_NormalPriority=3,t.unstable_Profiling=null,t.unstable_UserBlockingPriority=2,t.unstable_cancelCallback=function(L){L.callback=null},t.unstable_continueExecution=function(){x||m||(x=!0,X(C))},t.unstable_forceFrameRate=function(L){0>L||125<L?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):E=0<L?Math.floor(1e3/L):5},t.unstable_getCurrentPriorityLevel=function(){return f},t.unstable_getFirstCallbackNode=function(){return n(l)},t.unstable_next=function(L){switch(f){case 1:case 2:case 3:var O=3;break;default:O=f}var G=f;f=O;try{return L()}finally{f=G}},t.unstable_pauseExecution=function(){},t.unstable_requestPaint=function(){},t.unstable_runWithPriority=function(L,O){switch(L){case 1:case 2:case 3:case 4:case 5:break;default:L=3}var G=f;f=L;try{return O()}finally{f=G}},t.unstable_scheduleCallback=function(L,O,G){var j=t.unstable_now();switch(typeof G=="object"&&G!==null?(G=G.delay,G=typeof G=="number"&&0<G?j+G:j):G=j,L){case 1:var K=-1;break;case 2:K=250;break;case 5:K=1073741823;break;case 4:K=1e4;break;default:K=5e3}return K=G+K,L={id:d++,callback:O,priorityLevel:L,startTime:G,expirationTime:K,sortIndex:-1},G>j?(L.sortIndex=G,e(u,L),n(l)===null&&L===n(u)&&(_?(c(N),N=-1):_=!0,q(M,G-j))):(L.sortIndex=K,e(l,L),x||m||(x=!0,X(C))),L},t.unstable_shouldYield=W,t.unstable_wrapCallback=function(L){var O=f;return function(){var G=f;f=O;try{return L.apply(this,arguments)}finally{f=G}}}})(Xp);Wp.exports=Xp;var j0=Wp.exports;/**
 * @license React
...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Xi,depthTest:!1,depthWrite:!1})}function fp(){return new ti({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Zd(),fragmentShader:`
		...
		`,blending:Xi,depthTest:!1,depthWrite:!1})}function hp(){return new ti({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Zd(),fragmentShader:`
...
void main() {
	...
	gl_FragColor = pack2HalfToRGBA( vec2( mean, std_dev ) );
      ...
      `,transparent:!0,depthWrite:!1,blending:oo}),Ue=new Vu(Pe,Ve);ne.add(Ue);const Re=new Yn,_e=500,Ne=new Float32Array(_e*3),Ke=new Float32Array(_e);for(let Me=0;Me<_e;Me++)Ne[Me*3]=(Math.random()-.5)*300,Ne[Me*3+1]=(Math.random()-.5)*400,Ne[Me*3+2]=(Math.random()-.5)*300,Ke[Me]=2+Math.random()*3;Re.setAttribute("position",new Ut(Ne,3)),Re.setAttribute("size",new Ut(Ke,1));const dt=new ti({uniforms:{uTime:{value:0}},vertexShader:`
        attribute float size;
        uniform float uTime;
