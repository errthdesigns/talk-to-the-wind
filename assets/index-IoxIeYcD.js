...
#define LOW_PRECISION`),e}function Aw(t){let e="SHADOWMAP_TYPE_BASIC";return t.shadowMapType===Wg?e="SHADOWMAP_TYPE_PCF":t.shadowMapType===Jv?e="SHADOWMAP_TYPE_PCF_SOFT":t.shadowMapType===ai&&(e="SHADOWMAP_TYPE_VSM"),e}function Rw(t){let e="ENVMAP_TYPE_CUBE";if(t.envMap)switch(t.envMapMode){case Es:case ws:e="ENVMAP_TYPE_CUBE";break;case Ll:e="ENVMAP_TYPE_CUBE_UV";break}return e}function Cw(t){let e="ENVMAP_MODE_REFLECTION";if(t.envMap)switch(t.envMapMode){case ws:e="ENVMAP_MODE_REFRACTION";break}return e}function bw(t){let e="ENVMAP_BLENDING_NONE";if(t.envMap)switch(t.combine){case Xg:e="ENVMAP_BLENDING_MULTIPLY";break;case Ey:e="ENVMAP_BLENDING_MIX";break;case wy:e="ENVMAP_BLENDING_ADD";break}return e}function Pw(t){const e=t.envMapCubeUVHeight;if(e===null)return null;const n=Math.log2(e)-2,i=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,n),7*16)),texelHeight:i,maxMip:n}}function Lw(t,e,n,i){const r=t.getContext(),s=n.defines;let o=n.vertexShader,a=n.fragmentShader;const l=Aw(n),u=Rw(n),f=Cw(n),h=bw(n),d=Pw(n),m=n.isWebGL2?"":_w(n),x=vw(n),v=yw(s),p=r.createProgram();let c,g,_=n.glslVersion?"#version "+n.glslVersion+`
...
`].filter(as).join(`
`)),o=qc(o),o=Sp(o,n),o=Ep(o,n),a=qc(a),a=Sp(a,n),a=Ep(a,n),o=wp(o),a=wp(a),n.isWebGL2&&n.isRawShaderMaterial!==!0&&(_=`#version 300 es
...
void main() {
	...
	gl_FragColor = pack2HalfToRGBA( vec2( mean, std_dev ) );
      ...
      `,transparent:!0,depthWrite:!1,blending:oo}),we=new Vu(Ge,ae);ne.add(we);const Pe=new Yn,ze=2e3,Z=new Float32Array(ze*3),Je=new Float32Array(ze);for(let Me=0;Me<ze;Me++)Z[Me*3]=(Math.random()-.5)*900,Z[Me*3+1]=(Math.random()-.5)*600,Z[Me*3+2]=(Math.random()-.5)*600,Je[Me]=.5+Math.random()*1.5;Pe.setAttribute("position",new It(Z,3)),Pe.setAttribute("size",new It(Je,1));const Ve=new ti({uniforms:{uTime:{value:0}},vertexShader:`
        attribute float size;
        uniform float uTime;
      ...
      `,transparent:!0,depthWrite:!1,blending:oo}),Ie=new Vu(Pe,Ve);ne.add(Ie);const Re=new Yn,ve=500,Ne=new Float32Array(ve*3),Ke=new Float32Array(ve);for(let Me=0;Me<ve;Me++)Ne[Me*3]=(Math.random()-.5)*300,Ne[Me*3+1]=(Math.random()-.5)*400,Ne[Me*3+2]=(Math.random()-.5)*300,Ke[Me]=2+Math.random()*3;Re.setAttribute("position",new It(Ne,3)),Re.setAttribute("size",new It(Ke,1));const ft=new ti({uniforms:{uTime:{value:0}},vertexShader:`
        attribute float size;
        uniform float uTime;
